...
private _statement =
{
    ...
    systemChat format ["Open Dialog to configure placeholders for Screen %1", _screenIndex];
};
...
private _screenPlaceholdersAction = 
[
    format ["Screen%1Placeholders", _screenIndex], // Action name <STRING>
    "configure Placeholders", // Name of the action shown in the menu <STRING>
    "", // Icon <STRING>
